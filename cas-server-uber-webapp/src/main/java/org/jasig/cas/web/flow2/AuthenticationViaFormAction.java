...
public class AuthenticationViaFormAction {
    ...
    public final Event submit(final RequestContext context, final Credential credential,
        ...
        String wx= (String)WebUtils.getHttpServletRequest(context).getAttribute("wx");
        String providedLoginTicket="";
		if(HttpUtil.isWeixin(WebUtils.getHttpServletRequest(context))&& wx!=null && !"".equals(wx)){
			 providedLoginTicket = authoritativeLoginTicket;
		}else{
			 providedLoginTicket = WebUtils.getLoginTicketFromRequest(context);	
		}
