...
<c:if test="${not pageContext.request.secure}">
	<div id="msg" class="errors">
		<h4>Non-secure Connection</h4>
	</div>
</c:if>
<div class="login-wrap" style="text-align:center;">
        <div class="banner" style="float:left"><img src="${ctx}/images/login-1.jpg" alt="" /></div>
        <div class="login-form" style="float:left; margin-left: 20px;margin-top: 150px">
